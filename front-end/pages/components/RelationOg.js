        ...
        <div className={css.box}>
          <Grid container spacing={3}
              ...
              <Grid item xs={4} style={{paddingLeft:"0px",paddingTop:"0px"}}>                    
                <AlterType name = {this.props.idName} placeholder = {this.props.reId} onChange={this.handleSelect} options={this.props.relJson}/>
              </Grid>
              ...
              <Grid item xs={4} style={{paddingLeft:"0px",paddingTop:"0px"}}>                    
                <AlterType name = {this.props.pairName} placeholder = {this.props.relPair} onChange={this.handleSelect} options={pairOptions}/>
              </Grid> 
          </Grid>
...
class RelationOg extends Component {
    constructor(props) {
      super(props);
      this.arr =[]
          ...
          <div>
            {this.state.arr.map((item,index) => (
                <div key={item}>
                    ...
                    pairName={`relPair${item}`} num={this.props.num} reId={this.props.defaultId[index]} 
                    relPair={this.props.defaultPair[index]} value={this.props.value} />    
                </div>                     
            ))}
          </div>
        </div>
